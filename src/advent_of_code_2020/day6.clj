...
This list represents answers from five groups:
    ...
    b, and c. The second group contains three people; combined, they answered
    \"yes\" to 3 questions: a, b, and c. The third group contains two people;
    combined, they answered \"yes\" to 3 questions: a, b, and c. The fourth
    group contains four people; combined, they answered \"yes\" to only 1
    question, a. The last group contains one person who answered \"yes\" to only
    1 question, b.
...
(comment
  (count-answers (slurp (clojure.java.io/resource "day6.txt")))
  ;; => 6583
)
...
This list represents answers from five groups:
    ...
    a, b, and c. In the second group, there is no question to which everyone
    answered \"yes\". In the third group, everyone answered yes to only 1
    question, a. Since some people did not answer \"yes\" to b or c, they don't
    count. In the fourth group, everyone answered yes to only 1 question, a. In
    the fifth group, everyone (all 1 person) answered \"yes\" to 1 question, b.
...
(comment
  (count-answers-2 (slurp (clojure.java.io/resource "day6.txt")))
  ;; => 3290
)
